        ...
        <main className='page-container'>
            ...
            <div className='calc-container'>
                ...
                <form onSubmit={handleSubmit} className='params'>
                    ...
                    <label>
                        P :
                        <input type="number" name="p" value={params.p} onChange={handleChange} min="0.05"
                            step="0.05" className='input-number' /> kN
                    </label>
                    <label>
                        Mₓ :
                        <input type="number" name="mx" value={params.mx} onChange={handleChange} min="0.05"
                            step="0.05" className='input-number' /> kNm
                    </label>
                    <label>
                        Mᵧ :
                        <input type="number" name="my" value={params.my} onChange={handleChange} min="0.05"
                            step="0.05" className='input-number' /> kNm
                    </label>
                    <label className='param-label'>Column Parameters</label>
                    <label>
                        a :
                        <input type="number" name="a" value={params.a} onChange={handleChange} min="0.05"
                            step="0.05" className='input-number' /> m
                    </label>
                    <label className='param-label'>Footing Parameters</label>
                    <label>
                        L :
                        <input type="number" name="l" value={params.l} onChange={handleChange} min="0.05"
                            step="0.05" className='input-number' /> m
                    </label>
                    <label>
                        h₁ :
                        <input type="number" name="h1" value={params.h1} onChange={handleChange} min="0.05"
                            step="0.05" className='input-number' /> m
                    </label>
                    <label>
                        h₂ :
                        <input type="number" name="h2" value={params.h2} onChange={handleChange} min="0.05"
                            step="0.05" className='input-number' /> m
                    </label>
                    <label>
                        b :
                        <input type="number" name="b" value={params.b} onChange={handleChange} min="0.05"
                            step="0.05" className='input-number' /> m
                    </label>
