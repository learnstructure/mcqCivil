...
export default function Title() {
    ...
    return (
        <div className='mainNav'>
            <NavLink to='/' className='brand-nav-link' onClick={handleClick}>
                <img src={logo} alt="Civil Engineering MCQ" className='nav-logo-img' />
                <div className='logo'>
                    <span>CivilEngineering</span><span className='realm'>MCQ</span>
                </div>
            </NavLink>
            <nav className={
                ...
                <div className='dropdown'>
                    ...
                    <div className="dropdown-content">
                        ...
                        <NavLink to='/structure' onClick={handleClick}>Structural Analysis</NavLink>
                        ...
                        <NavLink to='/estimation' onClick={handleClick}>Estimation & Costing</NavLink>
