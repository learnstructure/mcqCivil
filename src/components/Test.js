        ...
        <div className="mcq" >
            ...
            <div className="option" >
                ...
                <p>
                    ...
                    <label for={`${props.serialno}optionA`}
                ...
                <p>
                    <input type="radio" name={`${props.serialno}options`} id={`${props.serialno}optionB`} value="b"
                        onChange={e => setAnswer(e.target.value)} />
                    <label for={`${props.serialno}optionB`} className={props.submitClicked && props.correct === "b" ? "correctAnswer" : null}>b) {props.optionB}</label>
                </p>
                <p>
                    <input type="radio" name={`${props.serialno}options`} id={`${props.serialno}optionC`} value="c"
                        onChange={e => setAnswer(e.target.value)} />
                    <label for={`${props.serialno}optionC`} className={props.submitClicked && props.correct === "c" ? "correctAnswer" : null}>c) {props.optionC}</label>
                </p>
                <p>
                    <input type="radio" name={`${props.serialno}options`} id={`${props.serialno}optionD`} value="d"
                        onChange={e => setAnswer(e.target.value)} />
                    <label for={`${props.serialno}optionD`} className={props.submitClicked && props.correct === "d" ? "correctAnswer" : null}>d) {props.optionD}</label>
                </p>
            </div>
