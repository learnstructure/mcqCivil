...
function Downloads() {
    return (
        <div className='page-container' style={{ lineHeight: '1.8rem' }}>
            ...
            <p >
                <a href='https://drive.google.com/file/d/1e6zmDjsIgbA5M4B0kE48HgprxTyhodRB/view?usp=drive_link' target="_blank" className='ext-link ext-link2' rel="noreferrer">Structure Analysis 1</a>
            </p>
            <p >
