...
function Blog6() {
    return (
        <main className='blog-container'>
            ...
            <p>It is important to note that even with significant bending stiffness, membrane forces can develop in a structure due to specific shape of structure. For example  tension and compression develop in curved surface like domes. This is analogous to arch in 1D.</p>
            ...
            <p>I have discussed about how moments are developed at a section in one of my previous posts. It is basically due to variation of normal stresses on a cross section. So in membrane theory, there is constant normal stress across thickness in membrane theory such that no bending moment develops.</p>
