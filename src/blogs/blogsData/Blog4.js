    ...
    return (
        <main className='blog-container'>
            <Helmet>
                ...
                <meta name="description" content="How to perform push over analysis in ETABS?" />
            </Helmet>
            <h1>How to perform pushover analysis in ETABS?</h1>
            ...
            <div className='img-flex'>
                ...
                <p>Let us suppose a simply supported beam of length L is subjected to uniformly distributed load (udl) of w as shown in figure aside. The figure also shows the bending stress distribution with maximum at outer fibers and zero at neutral axis. Bending stress σ=M/I y</p>
                <div><img src='/images/nonlinear/stress-strain.PNG' alt="beam and bending stress" /></div>
                <div><img src='/images/nonlinear/bending-stress.PNG' alt="beam and bending stress" /></div>
            </div>
            <div className='img-flex'>
                <p> Let’s assume the load was initially small so that stress at outermost fiber σ&lt;σᵧ where σᵧ is the yield stress. This is represented in fig a. Now as the load increases stress at outermost fiber reaches σᵧ as shown in fig b. Now on increasing load further, outermost stress remains constant at σ=σᵧ and stress at inner fibers increase to σᵧ. This is shown in fig c. If the load is further increased stress at all fibers becomes σᵧ as shown in fig d. This fig d is in plastic condition meaning whole section has reached plastic state σ=σᵧ   throughout the cross section. The moment at section where plastic condition has reached is called plastic moment (Mp) and the section is called plastic hinge section (in other words, plastic hinge has formed at that section). On any further increase on load, moment at the section remains constant at Mp and now behaves similar to normal internal hinge.</p>
                <div><img src='/images/nonlinear/plastic-stress.PNG' alt="formation of plastic hinge" /></div>
            </div>
            <p>Now we can easily calculate plastic moment using simple statics. But we won't do it right now because ETABS will automatically do that for us. If you want in depth explanation about <em>plastic analysis</em> , please let me know in the comment section below. If we are doing it in ETABS or any analysis software, we only have to input the stress strain diagram, like the elasto-plastic curve shown in first figure above. In ETABS there are options to generate auto hinge property based on ASCE 41-17 which simplifies the task.</p>

            <h2>Implementation in ETABS</h2>
            <h3>1. Modelling and initial design</h3>
            <p>If you are just starting non-linear analysis, start with a simple and small model because non-linear ana is time consuming and you may have to do it several times while learning at least.</p>
            <p>Creating a model is fairly easy. If you are new to ETABS, follow some beginner's videos on youtube.
                Apply all the static loads in respective load patterns. Also define equivalent static loads for earthquake. Run the analysis and design the structure.</p>
            ...
            <p>At this point I assume you successfully designed (preliminary) your structure. Now unlock the model. And let's define assign hinge property to the beams and columns.</p>
            ...
            <img src='/images/nonlinear/model.PNG' alt="formation of plastic hinge" style={{ maxWidth: "100%" }} />
            <ul>
                ...
                <li>Relative distance specifies the location where hinge will be formed. The hinges are likely to form where bending moment is maximum. Here we assume that hinges will be formed at 5% of span from each ends. (I didn't take the exact end points of frame because the joints are generally assumed to be rigid in RCC structures</li>
            ...
            <img src='/images/nonlinear/hinge.PNG' alt="formation of plastic hinge" style={{ maxWidth: "100%" }} />
            <ul>
                ...
                <li>Below is the screenshot of how hinge to be defined for columns. I have left many of the values as default since my purpose here is to carryout non-linear analysis and not to focus much on ASCE guidelines.</li>
            </ul>
            <img src='/images/nonlinear/hinge-col.PNG' alt="formation of plastic hinge" style={{ maxWidth: "100%" }} />
            <ul>
            ...
            <ul>
                <li>Below is screenshot of what parameters to set. Choose load case type as <strong>nonlinear</strong>  static</li>
            ...
            <img src='/images/nonlinear/displacement.PNG' alt="load control" style={{ maxWidth: "100%" }} />
            <ul>
            ...
            <ul>
                ...
                <li>We can see there are many steps for deformed shape for this nonlinear case (9 steps in my case). This is because loads are applied in stages (as I mentioned earlier) and there is change in stiffness due to various reasons of plasticity. ETABS reports the result at end of each step if requested.</li>
